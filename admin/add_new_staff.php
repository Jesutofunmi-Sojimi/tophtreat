...
<html>
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="add_new_staff.php">Staff</a></li>
 ...
 <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-5">                       
        <form action="add_new_staff1.php" method="POST" enctype="multipart/form-data">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD ADMIN </h3>          
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="mobile_no" placeholder="Contact" required="">
          </div> 
          ...
          <!--<div class="form-group">
            <input type="level" class="form-control" name="level" placeholder="Level" required="">
          </div> -->
         
          <div class="form-group">
          <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> ADD ADMIN </button>    
      </div>
        </form>
         <?php 
                                    if (isset($_GET['fmessage'])) {
                                      echo '<div class="alert alert-danger">This admin has been added before</div>';
                                    }
                                  ?>

                                  <?php 
                                    if (isset($_GET['smessage'])) {
                                      echo '<div class="alert alert-success">You have successfully added a new admin</div>';
                                    }
                                  ?>
        </div>
        <div class="col-lg-1"></div>
             ...
             <div class="col-lg-6">
            <P style="margin-bottom: 25px; text-align: center; font-size: 30px;">LIST OF ADMIN'S</P>
              ...
              echo '<tr><td>'.$row["fullname"].'</td><td>'.$row["mobile_no"].'</td><td><a  class="btn btn-danger" href="delete_member.php?staff_id='.$row["admin_id"].'"> DELETE</a></td></tr>';
                }
              ?>
              </table>
                            </div>
