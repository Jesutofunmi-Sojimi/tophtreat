    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-logo"><a href="index.html" class="brand-small text-center">T<strong></strong><strong class="text-primary">T</strong></a></div>
        </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
           ...
           <!-- <li><a href="view_reservation_details.php"> View Reservation Details</a></li>-->
            <li class="active"><a href="sales_report.php"> Generate Sales Report</a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <form method="post">
                    ...
                    <button class="btn btn-primary" name="submit">Generate Report</button>
                  </form>
...
if (isset($_POST['submit'])) {
                ?>
                  <table  class="table table-striped" width="100%">
                    <tr><th>Date/Time</th><th>Food</th><th>price</th><th>Quantity</th></tr>
                <?php
                  ...
                  if ($result) {
                      while ($fetchreport=mysqli_fetch_array($result)) {
                        echo'<tr><td>'.$fetchreport['order_date'].'</td><td>'.$fetchreport['foodname'].'</td><td>'.$fetchreport['price'].'</td><td>'.$fetchreport['quantity'].'</td><tr>' ;
                      }
                  }
                    
                  
                  ?><tr><td>Total</td><td>#550</td></tr></table>
                    <button onclick="window.print()" style="margin-left: 200px;" class="btn btn-primary">Print</button>
                                </div>
                <?php
                    }
                ?>
